    ...
    >
      <div className="h-full px-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-2">
          <NavItem text="Wishlist" isActive />
          <NavItem text="All Items" hasDropdown />
          <NavItem text="Categories" hasDropdown />
          <NavItem text="Collections" hasDropdown />
        </div>
            ...
            {showNotifications && (
              <div className={`absolute right-0 mt-2 w-80 rounded-md shadow-lg py-1 z-20 ${isDarkMode ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-200'}`}>
                <div className="px-4 py-2 text-sm font-medium border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                  ...
                  <span className="text-xs px-2 py-1 rounded-full bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200">4 New</span>
                </div>
                <div className="max-h-72 overflow-y-auto">
                  <a href="#" className={`block px-4 py-3 border-b ${isDarkMode ? 'border-gray-700 hover:bg-gray-700' : 'border-gray-100 hover:bg-gray-50'}`}>
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <p className="text-sm font-medium">Item back in stock</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">Product you wanted is available</p>
                        <p className="text-xs text-blue-600 dark:text-blue-400">2 min ago</p>
                      </div>
                    </div>
                  </a>
                </div>
