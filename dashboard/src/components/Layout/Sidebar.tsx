...
const Sidebar: React.FC<SidebarProps> = ({ isCollapsed, toggleSidebar }) => {
  ...
  // Render sidebar items based on configuration
  ...
  return (
    ...
    >
      ...
      {/* Sidebar Content */}
      <div className={`${isCollapsed ? 'p-2' : 'p-4'} overflow-y-auto h-[calc(100vh-4rem)]`} style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
        <style>{`
