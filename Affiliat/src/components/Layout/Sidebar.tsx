...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className={`fixed left-0 top-0 h-full bg-gray-800 dark:bg-gray-900 text-white transition-all duration-300 z-30 ${
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-700">
        <div className={`flex items-center space-x-3 ${isSidebarCollapsed ? 'justify-center' : ''}`}>
          ...
          {!isSidebarCollapsed && (
            <span className="text-xl font-bold">AFFILIATE</span>
          )}
        </div>
        <button
      ...
      <nav className="mt-6">
        <div className="space-y-1 px-3">
          <div className={`text-xs font-semibold text-gray-400 uppercase tracking-wider ${isSidebarCollapsed ? 'hidden' : 'px-3 mb-3'}`}>
            Overview
          </div>
